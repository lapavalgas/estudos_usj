...
public class CadastroFuncionario_b extends javax.swing.JFrame {
    ...
    public CadastroFuncionario_b() {
        initComponents();
        setLocationRelativeTo(null);
        ListaDep = (ArrayList<Departamento>) Sistema.ListaDep;  //carrega listas
        ListaFunc = (ArrayList<Funcionario>) Sistema.ListaFunc; //carrega listas
    ...
    private void btn_func_salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_func_salvarActionPerformed
        ...
        if (index == 0) {
            JOptionPane.showMessageDialog(this, "Você deve selecvionar uma departamento!");
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroFuncionario_b.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroFuncionario_b().setVisible(true);
            }
        });
    }
